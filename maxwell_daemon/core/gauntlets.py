...
class GauntletRun:
    ...
    def __post_init__(self) -> None:
        ...
        if self.status in _COMPLETED_GAUNTLET_STATUSES:
            require(self.final_decision is not None, "completed gauntlet requires a final decision")
            require(self.completed_at is not None, "completed gauntlet requires completed_at")
