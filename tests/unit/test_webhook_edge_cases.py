...
class TestWebhookEdgeCases:
    def test_handle_unknown_event_type(self) -> None:
        ...
        from maxwell_daemon.gh.webhook import WebhookConfig, WebhookRoute, WebhookRouter
    ...
    def test_dispatch_issues_invalid_number(self) -> None:
        ...
        router = WebhookRouter(
            WebhookConfig(
                secret="sec",
                allowed_repos=["owner/repo"],
                routes=[WebhookRoute("issues", "opened")],
            ),
            daemon=daemon,
        )
        assert (
    ...
    def test_dispatch_issues_string_labels(self) -> None:
        ...
        router = WebhookRouter(
            WebhookConfig(
                secret="sec",
                allowed_repos=["owner/repo"],
                routes=[WebhookRoute("issues", "opened", label="bug")],
            ),
            daemon=daemon,
        )
    ...
    def test_dispatch_comments_invalid_number(self) -> None:
        ...
        router = WebhookRouter(
            WebhookConfig(
                secret="sec",
                allowed_repos=["owner/repo"],
                routes=[WebhookRoute("issue_comment", "created")],
            ),
            daemon=daemon,
        )
        assert (
    ...
    def test_dispatch_comments_missing_trigger(self) -> None:
        ...
        router = WebhookRouter(
            WebhookConfig(
                secret="sec",
                allowed_repos=["owner/repo"],
                routes=[WebhookRoute("issue_comment", "created", trigger="fix")],
            ),
            daemon=daemon,
        )
        assert (
